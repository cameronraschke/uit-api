...
func (dto *JobQueueDBRow) ToDTO() (*JobQueueDTO, error) {
	...
	return &JobQueueDTO{
		...
		LastHeard:              dereferenceTimePtr(dto.LastHeard),
		SystemUptime:           NewDurationSeconds(dereferenceDurationPtr(dto.SystemUptime)),
		AppUptime:              NewDurationSeconds(dereferenceDurationPtr(dto.AppUptime)),
		Online:                 dto.Online,
...
type JobQueueDTO struct {
	...
	KernelUpdated          *bool           `json:"kernel_updated"`
	LastHeard              time.Time       `json:"last_heard"`
	SystemUptime           DurationSeconds `json:"system_uptime"`     // seconds
	AppUptime              DurationSeconds `json:"client_app_uptime"` // seconds
	Online                 *bool           `json:"online"`
	JobActive              *bool           `json:"job_active"`
	JobQueued              *bool           `json:"job_queued"`
	JobQueuedAt            time.Time       `json:"job_queued_at"`
